...
<form action="HistoryServlet" method="POST">
    <div class="modal fade" id="modalStatus" tabindex="-1" role="dialog" aria-labeledby="myModalHeader"
        aris-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="md-form mb-2">
                        ...
                        <input type="text" id="SotId" class="form-control"
                            value=<%= (session.getAttribute("otId") != null) ? session.getAttribute("otId") : ""%>>
                    </div>
                    <div class="md-form mb-2">
                        <label data-error="wrong" data-success="true" class="">Date</label>
                        <input type="date" id="Sotdate" class="form-control"
                            value=<%= (session.getAttribute("otDate") != null) ? session.getAttribute("otDate") : ""%>>
                    </div>
                    <div class="md-form mb-2">
                        <label data-error="wrong" data-success="true" class="">Duration</label>
                        <input type="text" id="Sotduration" class="form-control"
                            value=<%= (session.getAttribute("otDuration") != null) ? session.getAttribute("otDuration") : ""%>>
                    </div>
                    <div class="md-form mb-2">
                        <label data-error="wrong" data-success="true" class="">Description</label>
                        <input type="text" id="Sotdesc" class="form-control"
                            value=<%= (session.getAttribute("otDesc") != null) ? session.getAttribute("otDesc") : ""%>>
                    </div>
                    <div class="md-form mb-2">
                        <label data-error="wrong" data-success="true" class="">Time Sheet</label>
                        <input type="text" id="Stimesheet" class="form-control"
                            value=<%= (session.getAttribute("timesheet") != null) ? session.getAttribute("timesheet") : ""%>>
                    </div>
                    <!--                        <div class="md-form mb-2">
                    ...
                    <div class="au-card-inner">
                        ...
                        <div class="col-lg-12">
                            <div class="table-responsive table--no-card m-b-30">
                                ...
                                <table id="historyTable" class="table table-borderless table-striped table-earning"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-primary" data-toggle="modal"
                                                    data-target="#modalStatus" data-getid="<%= elem.getId()%>"
                                                    ...
                                                    data-getstatus="<%= elem.getStatus().getStatus()%>"><i
                                                        class="fas fa-edit"></i></button>
                                                <button type="button" class="btn btn-danger"
                                                    href="HistoryServlet?action=delete&id=<%= elem.getId()%>"><i
                                                        class="fas fa-trash"></i></button>
                                                <%} else {%>
                                                <button type="button" disabled="true"
                                                    class="btn btn-dark">CONFIRMED</button>
                                                <%}%>
                                                </td>
                                            </tr>
                                            <%}
